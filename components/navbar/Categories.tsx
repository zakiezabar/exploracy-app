...
export const categories = [
  ...
  },
  {
    ...
    description:
      "Football, basketball, paintball, badminton, yoga, pilates, meditation, boot camps, gym",
  },
  {
    ...
    description:
      "booard games, chess, cards, video games, escape rooms, karaoke, bowling, billiards, darts, table tennis, pool, foosball, laser tag, shooting, axe throwing, go-karting, trampoline park, roller skating, ice skating, bowling, mini golf, boot camps",
  },
  {
